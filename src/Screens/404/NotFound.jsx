...
const LostPage = () => {
  ...
  return (
<div className="lg:px-24 text-text1 dark:text-text2 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
